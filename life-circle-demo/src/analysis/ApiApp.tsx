  ...
  return <div className="api-app">
    ...
    <main className="api-layout">
      ...
      <section className="api-map-section">
        ...
        <ApiMap center={center} result={displayedResult?.isochrone} resultCenter={displayedResult?.center} layers={layers} onPick={choose} />
      </section>
    ...
    <footer className="api-footer">质量提示随采样证据展示；未知区域不代表不可达。设施统计与服务盲区尚未接入。</footer>
